defmodule EmbedChat.Repo.Metrics do
  ...
  def record_metric(entry) do
    query_time = System.convert_time_unit(entry.query_time + (entry.queue_time || 0), :native, :milliseconds)
    queue_time = System.convert_time_unit(entry.queue_time || 0, :native, :milliseconds)
